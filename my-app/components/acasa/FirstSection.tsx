    ...
    <div className="pt-36 pb-24  md:pb-24 md:pt-64 md:h-auto w-full px-8 md:px-16 lg:px-32 xl:px-36 2xl:px-96 bg-gray-50 flex items-center justify-between gap-24">
      <div className="md:w-5/12 w-full ">
        <h1 className="text-color-primary text-center md:text-left font text-2xl md:text-4xl">
          Descoperă echilibrul și claritatea interioară{" "}
        </h1>
        ...
        <p className="mt-8 mb-12 text-center md:text-left text-color-text">
          Bine ai venit! Sunt Adina Escu, psiholog specializat în dezvoltare
          personală și echilibru emoțional. Îți ofer sprijin și îndrumare pentru
          a naviga prin provocările vieții și a-ți descoperi resursele
          interioare pentru o stare de bine autentică.
        </p>
        <Link href="/contact">
